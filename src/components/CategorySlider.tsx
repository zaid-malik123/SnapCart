...
const CategorySlider = () => {
  const categories = [
        ...
        {name: "Household & Essentials", icon: Home , color: "bg-purple-100", id: 8},
  ...
  return (
    ...
    <div ref={scrollRef} className='flex gap-6 overflow-x-auto px-10 pb-4 scrollbar-hide scroll-smooth'>
        {categories.map((category) => {
            ...
            return <motion.div className= {`min-w-[150px] md:min-w-[180px] flex flex-col items-center gap-3 p-4 rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer ${category.color}`}>
